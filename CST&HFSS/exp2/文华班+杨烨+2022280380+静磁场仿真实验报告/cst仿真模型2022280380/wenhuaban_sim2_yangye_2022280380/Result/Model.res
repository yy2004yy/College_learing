...
lifetime=s:rebuild
result=s:1
files=s:B-Field (Ms)_Abs (Z)_1.rd1
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\1D Results\B-Field (Ms)_Abs (Z)
files=s:B-Field (Ms)_Abs (Z).rt1
files=s:B-Field (Ms)_Abs (Z).rd1
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\1D Results\B-Field (Ms)_Abs (Z)_1
files=s:B-Field (Ms)_Abs (Z)_1.rt1
files=s:B-Field (Ms)_Abs (Z)_1.rd1
